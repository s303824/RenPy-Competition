label part_2:
    ...
    inner_child"{color=#808080}{i}We’ve felt this before.{/i}" (multiple=2)

    menu:
        "\“Silenced.\”":
            death_drive"{color=#808080}Felt what?" (multiple=2)
        ...
        "\“Useless.\”":
            ...
            inner_child"{color=#808080}But there was something before that- something underneath. She just has to remember." (multiple=2)
    ...
    death_drive"..." (multiple=2)
    inner_child"{color=#808080}{i}You were only ten years old.{/i}" (multiple=2)
    ...
    death_drive"......" (multiple=2)
    inner_child"{color=#808080}{i}In hindsight, what else could she have done instead?{/i}" (multiple=2)
    ...
    inner_child"{color=#808080}{i}Who would believe us?{/i}" (multiple=2)

    death_drive"{color=#808080}{i}Who would care?{/i}" (multiple=2)
    ...
    death_drive"..." (multiple=2)
    inner_child"{color=#808080}{i}I know you know that this hasn’t been the case for quite some time.{/i}" (multiple=2)

    death_drive"{color=#808080}..." (multiple=2)
    inner_child"It’s just as you said: she’s waiting to die. No one is meant to shoulder this much grief." (multiple=2)

    death_drive"{color=#808080}..." (multiple=2)
    inner_child"The situation is dire, but we must know that she can fight this despair. She’s done it before, and she’ll do it once more." (multiple=2)
