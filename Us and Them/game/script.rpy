...
label intro:
    ...
    inner_child"{color=#808080}She’s still shutting her eyes." (multiple=2)
    ...
    death_drive"{color=#808080}And neither will listening to you." (multiple=2)
    ...
    inner_child"{color=#808080}Stop discrediting me." (multiple=2)

    death_drive"{color=#808080}I’m truly hard-pressed to think of a time in which you haven’t existed just to crush her spirits." (multiple=2)
    ...
    inner_child"{color=#808080}Stop! I’m tired of everyone ignoring what I have to say!" (multiple=2)

    death_drive"{color=#808080}Shut up- hold on. She’s noticing a sensation." (multiple=2)
    ...
    inner_child"{color=#808080}Ah!" (multiple=2)

    death_drive"{i}The blood caked on your fingers, though, has long been dried. After all, it’s not yours.{/i}" (multiple=2)
    inner_child"{color=#808080}Ah!" (multiple=2)

    death_drive"{color=#808080}{i}The blood caked on your fingers, though, has long been dried. After all, it’s not yours.{/i}" (multiple=2)
    ...
    inner_child"{color=#808080}{i}Don’t think about that.{/i}" (multiple=2)

    death_drive"{color=#808080}Then what the hell do you want her to think about?" (multiple=2)
