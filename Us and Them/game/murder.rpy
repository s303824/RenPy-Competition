...
# [FULL ROOM. Jin-Sol SITTING SPRITE]
    ...
    death_drive"{color=#808080}{cps=0}I don’t want to think about what happened either. But if you’re that adamant on holding out, I don’t think we have a choice." (multiple=2)
    ...
    mentor"{color=#808080}{cps=0}\“And then we can finally tell the world about the ruin this bastard politician caused during the war.\”" (multiple=2)
    mentor"\“Everyone else has forgotten us, but we won’t.\”" (multiple=2)

    mentor"\“...\”" (multiple=2)
    mentor"{color=#808080}{cps=0}\“Everyone else has forgotten us, but we won’t.\”" (multiple=2)

    mentor"{color=#808080}{cps=0}\“...\”" (multiple=2)
    mentor"\“I only hope this investigation will bring closure to the victims.\”" (multiple=2)

    mentor"\“...\”" (multiple=2)
    mentor"{color=#808080}{cps=0}\“I only hope this investigation will bring closure to the victims.\”" (multiple=2)
    ...
    menu:
        "\“It’s nothing.\”":
            ...
            mentor"{color=#808080}{cps=0}\“Heh, you’re such a liar. Are you worried about me?\”" (multiple=2)
    ...
    mentor"{color=#808080}{cps=0}\“And besides...\”" (multiple=2)
    mentor"\“He’s already here.\”" (multiple=2)

    mentor"\“Listen to me, Jin-Sol.\”" (multiple=2)
    mentor"{color=#808080}{cps=0}\“He’s already here.\”" (multiple=2)

    mentor"{color=#808080}{cps=0}\“Listen to me, Jin-Sol.\”" (multiple=2)
    mentor"\“Let’s see what happens.\”" (multiple=2)

    mentor"\“Oh shoot, did I give you a copy of the case files?\”" (multiple=2)
    mentor"{color=#808080}{cps=0}\“Let’s see what happens.\”" (multiple=2)

    mentor"{color=#808080}{cps=0}\“Oh shoot, did I give you a copy of the case files?\”" (multiple=2)
    ...
    menu:
        "{i}Take the briefcase.{/i}":
            ...
            mentor"{color=#808080}{cps=0}\“All of the evidence so far is in there.\”" (multiple=2)
